<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <?php
                echo form_open_multipart('backend/Auth/edit_admin', [
                    'autocomplete' => false, 'id' => 'edit_reg', 'method' => 'post'
                ], ['id'=>$this->url_encrypt->encode($Creator->id), 'type' => $this->url_encrypt->encode('tbl_admin')])
                ?>
                <input type="hidden" id="id" value="<?= $Creator->id ?>" name="creator_id">

                <div class="form-group row"><label for="name" class="col-sm-2 col-form-label">First Name *</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="first_name" name="first_name" value="<?= $Creator->first_name?>" placeholder="First Name">
                    </div>
                </div>

                <div class="form-group row"><label for="lat" class="col-sm-2 col-form-label">Last Name *</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="last_name" name="last_name" value="<?= $Creator->last_name?>" placeholder=" Last Name">
                    </div>
                </div>
                ...
                <div class="form-group row"><label for="long" class="col-sm-2 col-form-label">Email Id *</label>
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="email_id" name="email_id" value="<?= $Creator->email_id?>" placeholder=" Email Id">
                    </div>
                </div>
                ...
                <div class="form-group row"><label for="long" class="col-sm-2 col-form-label">Date of Birth *</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="<?= $Creator->date_of_birth?>" placeholder="Enter Date of Birth">
                    </div>
                </div>
                ...
                <div class="form-group row"><label for="long" class="col-sm-2 col-form-label">Gender *</label>
                    <div class="col-sm-10">
                        <div class="form-check form-check-inline">
                            ...
                            <input class="form-check-input" type="checkbox" name="gender" id="male" value="male" <?php echo $Creator->gender=='male'?'checked':'' ?>>
                            <label class="form-check-label" for="male" >Male</label>

                            <input class="form-check-input ml-3" type="checkbox" id="female" name="gender" value="female" <?php echo $Creator->gender=='female'?'checked':'' ?>>
                ...
                <div class="form-group row"><label for="long" class="col-sm-2 col-form-label">Pincode *</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="pincode" id="pincode" placeholder="Enter Your Pincode" value="<?= $Creator->pincode ?>">
                    </div>
                </div>
                        ...
                        <option value="">Select Occupation</option>
                          ...
                          <?php
                            foreach ($AllOccupation as $occupation) : ?>
                                <option value="<?php echo $occupation->id; ?>" <?php echo $occupation->id==$Creator->occupation_id?'selected':'' ?>><?php echo $occupation->name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                        ...
                        <option value="">Select Education</option>
                           ...
                           <?php
                            foreach ($AllEducation as $education) : ?>
                                <option value="<?php echo $education->id; ?>"<?php echo $education->id==$Creator->education_id?'selected':'' ?>><?php echo $education->name; ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-sm-10 mt-2">
                        ...
                        <option value="">Select Hobby</option>
                            ...
                            foreach ($AllHobby as $hobby) : ?>
                                <option value="<?php echo $hobby->id; ?>" <?php echo $hobby->id==$Creator->hobby_id?'selected':'' ?>><?php echo $hobby->name; ?></option>
                            <?php endforeach; ?>
                        ...
                        <option value="">Select Heard About Us</option>
                           ...
                           <?php
                            foreach ($AllHeardAbout as $heardabout) : ?>
                                <option value="<?php echo $heardabout->id; ?>" <?php echo $heardabout->id==$Creator->heard_about_us_id?'selected':'' ?>><?php echo $heardabout->name; ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-sm-10 mt-2">
                        ...
                        <?php
                            foreach ($AllAreaInterest as $areainterest) : ?>
                                <option value="<?php echo $areainterest->id; ?>" <?php echo $areainterest->id==$Creator->area_of_interest_id?'selected':'' ?>><?php echo $areainterest->name; ?></option>
                            <?php endforeach; ?>
