                    ...
                    <tbody>
                        <?php
                            ...
                            <td>
                                ...
                                |
                                <a href="<?= base_url('backend/creator/viewpurchase/'.$site->id) ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="view purchase"><span class="fa fa-money-bill"></span></a>
                                |
                                <a href="<?= base_url('backend/creator/export_excel/' . $site->id) ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Download Creator Transaction"><span class="fa fa-download"></span></a>
