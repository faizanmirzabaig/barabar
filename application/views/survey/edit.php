<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                echo form_open_multipart('backend/survey/update', [
                    'autocomplete' => false, 'id' => 'course_vali', 'method' => 'post'
                ], ['id' => $this->url_encrypt->encode($survey[0]->id), 'type' => $this->url_encrypt->encode('tbl_survey')]);
                ...
                <div class="form-group row"><label for="name" class="col-sm-2 col-form-label"> Survey name *</label>
                    <div class="col-sm-10">
                        ...
                        <input class="form-control" type="hidden" value="<?= $survey[0]->id ?>" name="id" required id="id">
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="course_type_id" <?= $status ?> required>
                            ...
                            foreach ($SurveyType as $surveytype) : ?>
                                <option value="<?php echo $surveytype->id; ?>" <?php echo $surveytype->id == $survey[0]->survey_type_id ? 'selected' : ''; ?> <?php $surveytype->id == $survey[0]->survey_type_id ? 'selected' : '' ?>><?php echo $surveytype->name; ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row"><label for="long" class="col-sm-2 col-form-label">Duration *</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="number" value="<?= $survey[0]->duration ?>" min="0" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" name="duration" required id="duration" placeholder="Enter Days" <?= $status ?>>
                ...
                <!-- <div class="form-group row"><label for="long" class="col-sm-2 col-form-label">Price *</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="number" value="<?= $survey[0]->price ?>"  min="0" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" name="price" required id="price" placeholder="Enter Price" <?= $status ?>>
                ...
                <div class="form-group row"><label for="language" class="col-sm-2 col-form-label">Language *</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" value="<?= $survey[0]->language ?>" name="language" required id="language" placeholder="Enter Language" <?= $status ?>>
                    </div>
                </div>
                ...
                <div class="form-group row"><label for="long" class="col-sm-2 col-form-label">Instructor *</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" value="<?= $survey[0]->writer ?>" name="writer" required id="writer" placeholder="Enter Instructor" <?= $status ?>>
                    </div>
                </div>
                ...
                <?php if (!empty($course[0]->price)) { ?>
                    <div class="form-group row"><label for="long" class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-10">
                            <image src="<?php echo base_url() ?>uploads/data/content/<?php echo $survey[0]->image ?>" style="width:20%" <?= $status ?>>
                        </div>
                    </div>
...
" class="col-sm-2 col-form-label">View *</label>
                <div class="col-sm-10">
                    <div class="form-check form-check-inline">
                        ...
                        <input class="form-check-input" type="radio" value="0" name="view" id="all_user" <?php echo ($survey[0]->view == 0) ? 'checked' : '' ?> <?= $status ?>>
                        <label class="form-check-label" for="all_user">All User</label>

                        <input class="form-check-input ml-3" type="radio" id="specific_user" <?php echo ($survey[0]->view == 1) ? 'checked' : '' ?> value="1" name="view" <?= $status ?>>
            ...
            <div id="specific_data">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select class="js-example-basic-multiple pincode" name="pincode[]" multiple="multiple" id="pincode" <?= $status ?>>
                            ...
                            <?php foreach ($UserPincode as $key => $value) {
                                $pincode_array = explode(',', $survey->pincode);
                            ?>
                ...
                <div class="form-group row"><label for="lat" class="col-sm-2 col-form-label">Age Group </label>
                    <div class="col-sm-10">
                        ...
                        <input type="number" name="min_age" maxlength="3" value="<?= $survey[0]->min_age ?>" class="from" <?= $status ?> />
                        <input type="number" name="max_age" maxlength="3" value="<?= $survey[0]->max_age ?>" class="to" <?= $status ?> />
                    </div>
                </div>
                    ...
                    <div class="col-sm-10 mt-2">
                        <select id="occupation" name="occupation" class="form-control" <?= $status ?>>
                            ...
                            foreach ($AllOccupation as $occupation) : ?>
                                <option value="<?php echo $occupation->id; ?>" <?php echo $occupation->id == $survey[0]->occupation_id ? 'selected' : '' ?>><?php echo $occupation->name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10 mt-2">
                        <select id="inputState" name="education" class="form-control" <?= $status ?>>
                            ...
                            foreach ($AllEducation as $education) : ?>
                                <option value="<?php echo $education->id; ?>" <?php echo $education->id == $survey[0]->education_id ? 'selected' : '' ?>><?php echo $education->name; ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-sm-10 mt-2">
                        <select id="inputState" class="form-control" name="hobby" <?= $status ?>>
                            ...
                            foreach ($AllHobby as $hobby) : ?>
                                <option value="<?php echo $hobby->id; ?>" <?php echo $hobby->id == $survey[0]->hobby_id ? 'selected' : '' ?>><?php echo $hobby->name; ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-sm-10 mt-2">
                        <select id="inputState" class="form-control" name="heard_about_us" <?= $status ?>>
                            ...
                            foreach ($AllHeardAbout as $heardabout) : ?>
                                <option value="<?php echo $heardabout->id; ?>" <?php echo $heardabout->id == $survey[0]->heard_about_us_id ? 'selected' : '' ?>><?php echo $heardabout->name; ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-sm-10 mt-2">
                        <select id="inputState" class="form-control" name="area_of_interest" <?= $status ?>>
                            ...
                            foreach ($AllAreaInterest as $areainterest) : ?>
                                <option value="<?php echo $areainterest->id; ?>" <?php echo $areainterest->id == $survey[0]->area_of_interest_id ? 'selected' : '' ?>><?php echo $areainterest->name; ?></option>
                            <?php endforeach; ?>
