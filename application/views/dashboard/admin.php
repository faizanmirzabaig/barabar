<div class="row">
    ...
    <div class="col-xl-3 col-md-6">
        <a href="<?= base_url("backend/manager") ?>">
            <div class="card bg_dasbord_box mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        <div class="float-left mini-stat-img mr-4"><img src="<?= base_url("assets/images/coin.png") ?>"
                                alt=""><i class="fa fa-user"></i></div>
                        <h5 class="font-14 text-uppercase mt-0 text-white-50">Total no. of Managers</h5>
                        <h4 class="font-500"><?= number_format($totalmanager) ?></h4>
