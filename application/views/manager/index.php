                ...
                <table id="datatable-excel" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php
                            ...
                            <td><?= date("d-m-Y h:i:s A",strtotime($site->created_date))?></td>
                            <td>
                                <a href="<?= base_url('backend/manager/edit/'.$site->id) ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><span class="fa fa-edit"></span></a>
                                |
                                <a href="<?= base_url('backend/manager/delete/'.$site->id) ?>" onclick="return confirm('Are You Sure Want To Delete This Manager?')" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><span class="fa fa-trash"></span></a>
                                <!-- | -->
                                <!-- <a href="<?= base_url('backend/manager/viewcontent/'.$site->id) ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Edit Content"><span class="fa fa-plus"></span></a>
                                | -->
