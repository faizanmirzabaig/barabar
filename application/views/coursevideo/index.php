                ...
                <table id="datatable-excel" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php
                            ...
                            <td>
                                <a href="<?= base_url('backend/course/editvideo/'.$site->id.'/'.$site->chapter_id) ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><span class="fa fa-edit"></span></a>
                                |
                                <a href="<?= base_url('backend/course/deletevideo/'.$site->id) ?>" onclick="return confirm('Are You Sure Want To Remove This Course Video?')" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><span class="fa fa-trash"></span></a>
                                |
                                <a href="<?= base_url('backend/quiz/List/'.$site->id) ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Add Quiz"><span class="fa fa-plus"></span></a>
                            </td>
                        </tr>
                            <?php }
                        ?>
