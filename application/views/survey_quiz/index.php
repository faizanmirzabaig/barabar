                ...
                <table id="datatable-excel" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php
                            ...
                            <td>
                                <a href="<?= base_url('backend/survey_quiz/editquiz/'.$site->video_id.'/'.$site->id) ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><span class="fa fa-edit"></span></a>
                                |
                                <a href="<?= base_url('backend/survey_quiz/deletequiz/'.$site->id) ?>" onclick="return confirm('Are You Sure Want To Remove This Quiz?')" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><span class="fa fa-trash"></span></a>
                            </td>
                        </tr>
                            <?php }
                        ?>
